...
#dll imports
everything_dll = ctypes.WinDLL (r"D:\Program Files\Everything\dll\Everything64.dll")
...
#setup search
everything_dll.Everything_SetSearchW("test0.py")
